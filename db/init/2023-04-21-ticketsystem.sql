...
('txtCheckFirst', 'Ihr Support-Ticket mit der Ticketnummer: ', 'Your support ticket with the ticket number: '),
...
('txtDescriptionReferenceError', 'Geben Sie eine Beschreibung und Betreff ein!', 'Enter a description and a reference!'),
