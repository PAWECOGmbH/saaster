...
-- Records of modules
-- ----------------------------
INSERT INTO `modules` VALUES (1, 'Free Todo list app', 'Let your tasks be done', '<p>With this small but powerful tool for task management, you always have all your tasks under control. Simply click on \"Activate\" and get started :-)<br></p>', 1, 'todo_', '', 0, 1, '2022-03-28 14:54:17');
INSERT INTO `modules` VALUES (2, 'Easy ERP', 'Manage your contacts using Easy CRM', '<p>Manage your contacts easily with Easy ERP. Many features are included here, such as:<br><br>- Create and manage contacts<br>- Customer history<br>- Acquisition<br>- Appointment management<br>- and much more...<br></p>', 1, 'easy-erp_', '', 1, 2, '2022-03-28 15:19:23');
...
-- ----------------------------
INSERT INTO `modules_prices` VALUES (1, 1, 1, 0.00, 0.00, 0.00, 0, 3);
INSERT INTO `modules_prices` VALUES (2, 1, 2, 0.00, 0.00, 0.00, 0, 3);
INSERT INTO `modules_prices` VALUES (3, 2, 1, 29.00, 290.00, 7.70, 1, 1);
INSERT INTO `modules_prices` VALUES (4, 2, 2, 35.00, 350.00, 7.70, 1, 1);
