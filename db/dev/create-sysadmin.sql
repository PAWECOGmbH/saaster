...
VALUES (1, 0, UTC_TIMESTAMP(), UTC_TIMESTAMP(), 1, 'The SaaSter Company Ltd.', 'Peter Pan', 'Workingstreet 199', 'House 5b', '78000', 'Worksher', 0, 31, '041 555 55 55',
...
INSERT INTO `users` VALUES  (1, 1, UTC_TIMESTAMP(), UTC_TIMESTAMP(), 'Mister', 'Peter', 'Pan', 'admin@saaster.io',
...
'041 555 55 60', '079 888 55 22', '', 'en', 1, NULL, 1, 1, 1, NULL, UTC_TIMESTAMP());
