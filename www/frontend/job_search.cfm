...
<cfscript>
    ...
    // Default ads array
    arrayAds = application.objAdsFrontend.getAds(search = session.searchData);
    totalAds = arrayLen(arrayAds);
...
<main>
    ...
    <section class="bg-color hero-section py-sm-5 py-0">
        <div class="container d-flex flex-md-row flex-column justify-content-between align-items-center w-100 gap-btw py-md-0 pt-4 pb-4 title-mx">
            <div class="d-flex w-100 flex-column row-gap-sm-2 align-items-start justify-content-start hero-txt">
                <h1 class="lh-base">Suche nach Stelle</h1>
            ...
            <div class="search-filter">
                <div class="filter-head">
                    ...
                    <cfif isStruct(session.searchData) and !structIsEmpty(session.searchData)>
                        <a href="#application.mainURL#/stelle-suchen?del_search" class="clear-search">
            ...
            <div class="w-100">
                <div class="w-100 job-search position-relative container mx-auto">
                    <div class="input-group">
                        ...
                        <cfelse>
                            <input class="form-control" type="text" name="searchQuery" placeholder="Beruf, Stichwort oder Unternehmen" aria-label="Search">
                        </cfif>
                    </div>

                    <div class="py-4 job-card-container stelle-cards container mx-auto px-xl-0 gap-btw">
                        <h2>#totalAds# Stellen gefunden</h2>
