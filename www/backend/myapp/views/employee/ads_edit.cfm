...
<cfscript>
    ...
    qAd = objAds.getAdDetails(adID, 2);
        ...
        <div class="row mb-3">
            <div class="col-md-12 col-lg-12">
                ...
                <div class="#getLayout.layoutPageHeader# col-lg-9 col-md-8 col-sm-8 col-xs-12 float-start">
                    <h4 class="page-title">Ihr Jobprofil</h4>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Bearbeiten Sie Ihr Jobprofil</h3>
                    </div>
                    <div class="card-body">
                        <cfif session.currentPlan.status eq "free">
                            <p>
                                Sie können Ihr Jobprofil jederzeit öffentlich schalten und wieder deaktivieren.
                                Nachdem Sie den Plan "FINDEN LASSEN" gebucht haben, können Sie bestimmen,
                                welche persönlichen Informationen Sie auf Stellensuche.ch veröffentlichen wollen und welche nicht.
                                <a href="#application.mainURL#/account-settings/plans">Plan wechseln.</a>
                            </p>
                        <cfelse>
                            <p>
                                Sie können Ihr Jobprofil jederzeit aktivieren oder deaktivieren und auch entscheiden,
                                welche persönlichen Daten Sie öffentlich anzeigen wollen und welche nicht.
                            </p>
                            <p><a href="#application.mainURL#/employee/ads/settings">Hier gelangen Sie zu den Einstellungen.</a></p>
                        </cfif>
                    </div>
                    <form action="#application.mainURL#/handler/ads" method="post">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-7">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control editor_small" name="description" style="height: 400px;" placeholder="Schreiben Sie etwas..." required>#qAd.strJobDescription#</textarea>
                                    </div>
                                </div>
                                <div class="col-lg-5">
                                    <div class="mb-3 pt-4 small text-muted">
                            ...
                            <div class="col-lg-6 mt-4 mb-3">
                                ...
                                <cfif session.currentPlan.status neq "free">
