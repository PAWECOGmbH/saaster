            ...
            <div class="col-lg-6">
                ...
                <div class="mb-3">
                    ...
                    <fieldset class="form-fieldset">
                        <div class="mb-3">
                            <small class="form-hint mb-3"><b>The folder and files will be created after saving.<br> The <i>navigation.cfm</i> file will help build the navigation.</b></small>
                            <label class="mb-1">Folder and table prefix *</label>
                            <input type="text" class="form-control" name="prefix" placeholder="prefix" autocomplete="off" maxlength="20" value="#HTMLEditFormat(qModule.strTabPrefix)#" required <cfif len(trim(qModule.strSettingPath))>disabled style="cursor: not-allowed;" data-bs-toggle="tooltip" title="You cant change the prefix after creation. Create a new module instead."</cfif>>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-lg-4">
                        ...
                        <cfif qModule.blnFree>
                            <input type="text" class="form-control text-end" value="0" disabled style="cursor: not-allowed;" data-bs-toggle="tooltip" data-bs-placement="top" title="Its a free module">
                        <cfelse>
                ...
                <div class="row mb-3">
                    <div class="col-lg-5">
                        <label class="form-label">Number of duration days</label>
                        <cfif qModule.blnFree>
                            <input type="text" class="form-control text-end" value="0" disabled style="cursor: not-allowed;" data-bs-toggle="tooltip" data-bs-placement="top" title="Its a free module">
                        <cfelse>
                            <input type="text" class="form-control text-end" name="duration_days" autocomplete="off" value="#qModule.intDurationDays#" placeholder="0" required>
                        </cfif>
                        <small class="form-hint">
                            If your module is only available for a certain period, you can specify the number of days here. The price is taken from the "Onetime Price" field.
                        </small>
                    </div>
                </div>
            </div>
