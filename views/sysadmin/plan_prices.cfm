                    ...
                    <thead>
                        ...
                        <cfloop query="qPrices">
                            <tr>
                                ...
                                <td align="right">
                                    <input type="text" name="pricemonthly_#qPrices.currID#" class="form-control text-end w-75" autocomplete="off" value="#trim(lsNumberFormat(qPrices.decPriceMonthly))#" maxlength="10" required>
                                </td>
                                <td align="right">
