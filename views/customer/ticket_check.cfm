                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="col-10 d-none d-lg-block">
                                <p class="text-check-large">#getTrans('txtCheckFirst')##session.ticket##getTrans('txtCheckSecond')#<br>#getTrans('txtCheckThird')#</p>
                            </div>
                            <div class="col-10 d-lg-none">
                                <p class="text-check-small">#getTrans('txtCheckFirst')##session.ticket##getTrans('txtCheckSecond')#<br>#getTrans('txtCheckThird')#</p>
                            </div>
                        </div>
                    </div>
                </div>
