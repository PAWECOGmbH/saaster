                                ...
                                <div class="table-responsive">
                                    <table class="table card-table table-vcenter text-nowrap datatable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="w-20 text-center">#getTrans('btnDelete')#</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <cfset countEntrys = 1>
                                            <cfloop array="#qTotalCount#" index="i" item="notificationitem">
                                                ...
                                                <cfoutput>
                                                    <tr class="border-k-0">
                                                        <td class="border-k-0"><input role='button' name="" id="#notificationitem.intNotificationID#" class="form-check-input m-0 align-right notificationCheckBox" type="checkbox" aria-label="Select invoice"></td>
                                                        <td class="border-k-0"><a role='button' class="text-reset notificationText" data-location="#application.mainURL#/handler/ajax_notificationhandler.cfm?notificationID=#notificationitem.intNotificationID#" id="#notificationitem.intNotificationID#" tabindex="-1">#getTrans(notificationitem.strTitleVar)#</a></td>
                                                        <td class="border-k-0">#lsDateFormat(notificationitem.dtmCreated)#</td>
                                                        <td class="border-k-0 text-center" id="msgReadIcon#notificationitem.intNotificationID#">
                                                        ...
                                                        <td class="border-k-0 text-center">
                                                    ...
                                                    <tr class="custom-w" id="#notificationitem.intNotificationID#-">
                                                        <td class="p-0" ></td>
                                                        <td class="p-0"  colspan="4" >
                                                            <div class="border-t-0 notificationiAnimation custom-w-9 w-break my-2 p-2" style="display:none;">
                                                                #getTrans(notificationitem.strDescrVar)#
                                                                <a href="#notificationitem.strLink#" class="d-block mt-1">#getTrans(notificationitem.strLinkTextVar)#</a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </cfoutput>
                                    ...
                                    <cfoutput>
                                        <div class="card-body d-flex">
                                            <ul class="mb-0 ps-0">
                                                <i role='button' id="deleteAllSelected" style="display:none;" data-location="#application.mainURL#/handler/ajax_notificationhandler.cfm?deleteall" class="fas fa-trash-can"></i>
                                ...
                                <div class="table-responsive">
                                    <table class="table card-table table-vcenter text-nowrap datatable">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td></td>
                                                <td>#getTrans('txtNotificationEmpty')#</td>
                                                <td></td>
                                                <td></td>
                                                <td></td>
                                            </tr>
